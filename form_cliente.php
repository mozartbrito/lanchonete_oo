		...
		<div class="col-9">
			...
			<div class="row">
				<div class="form-group col-4">
					...
					<input type="text" name="cpf" id="cpf" value="<?= ($cliente->getCpf() != '' ? $cliente->getCpf() : '' ) ?>" class="form-control">
				</div>
				<div class="form-group col-4">
			...
			<div class="row">
				<div class="form-group col-3">
					...
					<input type="text" name="celular" id="celular" value="<?= ($cliente->getCelular() != '' ? $cliente->getCelular() : '') ?>" class="form-control">
				</div>
				<div class="form-group col-3">
			...
			<div class="row">
				<div class="form-group col-4">
					...
					<input type="text" name="cep" id="cep" value="<?= ($cliente->getCep() != '' ? $cliente->getCep() : ''); ?>" class="form-control">
				</div>
